...
export function MainLayout({
  ...
  children: React.ReactNode
    ...
    return(
        <div id='layout-grid' className='md:grid md:grid-cols-12 gap-standard-gap mx-standard-gap'>
          <StaticMenuContext.Provider value={value}>
            <StaticMenu />
            <div id='content' className='my-big-gap mx-auto max-w-[500px] md:ml-0 md:w-full md:col-span-8 2xl:col-span-10'>
              {children}
            </div> 
