...
export default async function Page() {
    ...
    return(
        <div className='p-[10vw]'>
            ...
            <div>
                <CaseStudyOverview props={data.overview}/>
                <div className='mt-[6rem] mb-[6rem] bg-border h-[2px] w-[100%] w-[70vw] m-auto'></div>
            </div>
            <div>
                <CaseStudySection {...data.observations}/>
                <div className='mt-[6rem] mb-[6rem] bg-border h-[2px] w-[100%] w-[70vw] m-auto'></div>
            </div>
            <div>
                <CaseStudySection {...data.interviews}/>
                <div className='mt-[6rem] mb-[6rem] bg-border h-[2px] w-[100%] w-[70vw] m-auto'></div>
            </div>
            <div>
                <CaseStudySection {...data.netnography}/>
                <div className='mt-[6rem] mb-[6rem] bg-border h-[2px] w-[100%] w-[70vw] m-auto'></div>
            </div>
            <div>
                <CaseStudyBigText {...data.howMightWe}/>
                <div className='mt-[6rem] mb-[6rem] bg-border h-[2px] w-[100%] w-[70vw] m-auto'></div>
            </div>
            <div>
                <CaseStudySection {...data.persona}/>
                <div className='mt-[6rem] mb-[6rem] bg-border h-[2px] w-[100%] w-[70vw] m-auto'></div>
            </div>
            <div>
                <CaseStudySection {...data.paperPrototype}/>
                <div className='mt-[6rem] mb-[6rem] bg-border h-[2px] w-[100%] w-[70vw] m-auto'></div>
            </div>
            <div>
                <CaseStudyInsights {...data.prototypeInsights}/>
                <div className='mt-[6rem] mb-[6rem] bg-border h-[2px] w-[100%] w-[70vw] m-auto'></div>
            </div>
            <div>
                <CaseStudySection {...data.midFiPrototype}/>
                <div className='mt-[6rem] mb-[6rem] bg-border h-[2px] w-[100%] w-[70vw] m-auto'></div>
            </div>
            <div>
                <CaseStudyInsights {...data.midFiInsights}/>
                <div className='mt-[6rem] mb-[6rem] bg-border h-[2px] w-[100%] w-[70vw] m-auto'></div>
            </div>
            <div>
                <CaseStudySection {...data.branding}/>
                <div className='mt-[6rem] mb-[6rem] bg-border h-[2px] w-[100%] w-[70vw] m-auto'></div>
            </div>
            <div>
                <CaseStudyVideo {...data.hiFiPrototype}/>
                <div className='mt-[6rem] mb-[6rem] bg-border h-[2px] w-[100%] w-[70vw] m-auto'></div>
            </div>
            <div>
                <CaseStudySection {...data.reflection}/>
                <div className='mt-[6rem] mb-[6rem] bg-border h-[2px] w-[100%] w-[70vw] m-auto'></div>
            </div>
        </div>
    )
